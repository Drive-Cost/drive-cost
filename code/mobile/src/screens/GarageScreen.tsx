...
export default function GarageScreen() {
  const { vehicles, loadVehicles, setActiveVehicle, activeVehicleId } =
    useVehicleStore();
    ...
    <View style={styles.screen}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Choose the car you want DriveCost to track.
        </Text>
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptyText}>
              Start with one car and keep everything local while we shape the
              first version.
            </Text>
          </View>
        }
        renderItem={({ item }) => (
          <View
            style={[
              styles.vehicleCard,
              item.id === activeVehicleId && styles.vehicleCardActive,
            ]}
          >
            <Pressable onPress={() => setActiveVehicle(item.id!)}>
              ...
              <Text style={styles.vehicleMeta}>
                Odometer {item.currentOdometer.toLocaleString()} km
              </Text>
              <Text style={styles.vehicleMeta}>
              ...
              {item.id === activeVehicleId ? (
                <Text style={styles.activeTag}>Active vehicle</Text>
              ) : null}
            </Pressable>
            ...
            <View style={styles.cardActions}>
              ...
              <Pressable
                ...
                onPress={() =>
                  navigation.navigate(
                    "EditVehicle" as never,
                    { vehicleId: item.id } as never,
                  )
                }
              >
