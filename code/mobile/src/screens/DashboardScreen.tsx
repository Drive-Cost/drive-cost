...
export default function DashboardScreen() {
    ...
    return (
      <View style={styles.emptyState}>
        ...
        <Text style={styles.emptyText}>
          Add your first car in Garage to start tracking fuel, maintenance, and
          cost per kilometer.
        </Text>
      </View>
    );
  ...
  const totalMaintenanceCost =
    calculateTotalMaintenanceCost(maintenanceEntries);
  const totalCost = totalFuelCost + totalMaintenanceCost;
  const mileageSnapshot = createMileageSnapshot(
    vehicle,
    fuelEntries,
    maintenanceEntries,
  );
    ...
    >
      ...
      <View style={styles.insightCard}>
        ...
        <Text style={styles.insightValue}>
          {mileageSnapshot.trackedDistance.toLocaleString()} km
        </Text>
        ...
        <Text style={styles.insightHint}>
          For now this is explicit tracking distance, not full ownership
          distance. Later we can separate purchase mileage, tracking baseline,
          and live odometer.
        </Text>
      </View>
      ...
      <View style={styles.timelineCard}>
        <View style={styles.timelineHeader}>
          ...
          <Text style={styles.timelineSubtitle}>
            Simple signals tailored to your vehicle profile
          </Text>
        </View>

        {insights.length === 0 ? (
          <Text style={styles.emptyTimeline}>
            Add a few entries and DriveCost will start showing cost and usage
            patterns here.
          </Text>
        ) : (
      ...
      <View style={styles.timelineCard}>
        <View style={styles.timelineHeader}>
          ...
          <Text style={styles.timelineSubtitle}>
            Fuel and maintenance, newest first
          </Text>
        </View>

        {recentEvents.length === 0 ? (
          <Text style={styles.emptyTimeline}>
            Your timeline will appear here after the first entries.
          </Text>
        ) : (
